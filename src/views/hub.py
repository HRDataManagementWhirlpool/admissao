...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.second_frame_button_1 = customtkinter.CTkButton(self.second_frame, text="Selecione a pasta", image=self.image_icon_image, compound="right", command=self.select_directory)
